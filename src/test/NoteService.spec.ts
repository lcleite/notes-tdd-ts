...
// import {NoteDataService} from "../app/data/service/NoteDataService";
// import {NoteDataServiceImpl} from "../app/data/service/impl/NoteDataServiceImpl";
// import {TestBed} from "@angular/core/testing";
//
// describe('NoteDataService test', () => {
//
//   let noteService: NoteDataService;
//
//   // beforeAll(() => {
//   //   noteService = new NoteDataServiceImpl();
//   // });
//
//   beforeEach(() => {
//     // refine the test module by declaring the test component
//     TestBed.configureTestingModule({
//       providers: [NoteDataServiceImpl]
//     });
//
//     // UserService provided to the TestBed
//     noteService = TestBed.get(NoteDataServiceImpl);
//   });
//
...
//   // });
//
//   it('should get all data entity notes', () => {
//
//     return Promise.resolve(noteService.getAll())
//       .then((allNotes) => {
//         console.log(allNotes);
